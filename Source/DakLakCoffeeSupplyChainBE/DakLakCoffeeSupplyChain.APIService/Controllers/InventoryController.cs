...
namespace DakLakCoffeeSupplyChain.APIService.Controllers
{
    ...
    public class InventoriesController : ControllerBase
    {
        ...
        // GET: api/Inventories/available-for-product
        [HttpGet("available-for-product")]
        [Authorize(Roles = "BusinessManager,BusinessStaff")]
        public async Task<IActionResult> GetAvailableForProduct()
        {
            var userIdClaim = User.FindFirst(ClaimTypes.NameIdentifier);
            ...
            var result = await _inventoryService
                .GetAvailableForProductAsync(userId);
