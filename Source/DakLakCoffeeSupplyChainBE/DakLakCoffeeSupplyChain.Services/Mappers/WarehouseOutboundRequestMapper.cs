    ...
    public static class WarehouseOutboundRequestMapper
    {
        ...
        public static WarehouseOutboundRequestDetailDto ToDetailDto(this WarehouseOutboundRequest e)
            => new()
            {
                ...
                InventoryCode = e.Inventory?.InventoryCode,
                ...
                InventoryUnit = e.Inventory?.Unit,
                RequestedQuantity = e.RequestedQuantity,
                Unit = e.Unit,
                Purpose = e.Purpose,
                Reason = e.Reason,
                OrderItemId = e.OrderItemId,
                OrderItemProductName = e.OrderItem?.Product?.ProductName,
                OrderItemCoffeeTypeName = e.OrderItem?.Product?.CoffeeType?.TypeName,
