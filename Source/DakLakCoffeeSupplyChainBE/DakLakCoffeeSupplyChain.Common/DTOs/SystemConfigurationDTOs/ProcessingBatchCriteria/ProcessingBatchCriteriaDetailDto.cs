...
{
    /// <summary>
    /// DTO cho việc xem chi tiết tiêu chí đánh giá chất lượng ProcessingBatch
    /// </summary>
    public class ProcessingBatchCriteriaDetailDto
    {
        ...
        // Thông tin bổ sung
        public string TargetEntity { get; set; } = "ProcessingBatch";
