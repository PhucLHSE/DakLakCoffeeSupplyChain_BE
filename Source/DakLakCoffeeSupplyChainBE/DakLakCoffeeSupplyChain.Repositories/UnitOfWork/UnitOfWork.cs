...
namespace DakLakCoffeeSupplyChain.Repositories.UnitOfWork
{
    public class UnitOfWork : IUnitOfWork
    {
        ...
        private IFarmingCommitmentsDetailRepository? farmingCommitmentsDetailRepository;
        ...
        private IPaymentConfigurationRepository? paymentConfigurationRepository;
        ...
        public IProcessingWasteDisposalRepository ProcessingWasteDisposalRepository
        {
            get
            {
                return processingWasteDisposalRepository ??= new ProcessingWasteDisposalRepository(context);
            }
        }

        public IFarmingCommitmentsDetailRepository FarmingCommitmentsDetailRepository
        {
            get
            {
                return farmingCommitmentsDetailRepository ??= new FarmingCommitmentsDetailRepository(context);
            }
        }
        ...
        public IShipmentRepository ShipmentRepository
        {
            get
            {
                return shipmentRepository ??= new ShipmentRepository(context);
            }
        }
        ...
        public IPaymentConfigurationRepository PaymentConfigurationRepository
        {
            get
            {
                return paymentConfigurationRepository ??= new PaymentConfigurationRepository(context);
            }
        }
        ...
        public ICropRepository CropRepository
        {
            get
            {
                return cropRepository ??= new CropRepository(context);
            }
        }
